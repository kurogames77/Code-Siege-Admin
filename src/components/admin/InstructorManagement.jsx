...
import { Search, MoreVertical, FileText, Mail, User, Ban, Edit2, Shield } from 'lucide-react';
...
const InstructorManagement = ({ theme = 'dark' }) => {
    ...
    return (
        <div className="grid grid-cols-1 gap-8 h-full overflow-hidden max-w-5xl mx-auto w-full">
            {/* ACTIVE INSTRUCTORS */}
